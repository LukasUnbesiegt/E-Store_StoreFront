			...
			return items.map(item => {
				return (
					<ListGroupItem className="">
						<ListGroupItemHeading>{item.product.name}</ListGroupItemHeading>
						<ListGroupItemText>Qty : {item.quantity}</ListGroupItemText>
						<ListGroupItemText>Price : {item.TotalPrice}</ListGroupItemText>
						<ListGroupItemText>
