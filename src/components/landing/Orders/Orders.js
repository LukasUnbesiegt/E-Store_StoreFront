...
import { FB_APP_ID, globalStyle } from "../../../config";
				...
				return (
					<div className="my-3 py-3">
						...
						<AccountKit
							...
							version="v1.1"
							onResponse={resp => {
								this.accountKitLoginHandler(resp);
							}}
							csrf={"yngWIE273929"}
							countryCode={"+95"}
							display={"modal"}
		...
		return (
			<Fragment>
				...
				<div className="container py-4 my-2">
					...
					<h5 className="text-center text-muted display-4 mb-3">
						User Information and Payment Form
					</h5>
