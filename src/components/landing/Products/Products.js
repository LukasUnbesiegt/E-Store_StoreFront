...
import { getCategories, getProductsForShop, addLike } from '../../../actions/productsActions'
...
class Products extends Component {
                ...
                <div className="col-md-10 col-sm-12 py-2">
                    <div className="form-group">
                        <div className="input-group mb-4">
                            ...
                            <input
                                className="form-control" placeholder="Search" type="text" name="name"
        ...
        return (
            ...
            <div>
                ...
                <CheckBoxFilter
                    ...
                    handleFilters={(filters) => { this.handleFilters(filters, 'collections') }}
    ...
    render() {
        ...
        const renderPagination = () => {
            ...
            if (this.props.productsToShop && this.props.productsToShop.products.length > 0) {
...
const mapDispatchToProps = {
    getProductsForShop, addLike
}




export default connect(mapStateToProps, mapDispatchToProps)(Authenticated(Products, true));